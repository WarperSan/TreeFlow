...
namespace TreeFlow.Editor.Renderers
{
    ...
    internal class NodeRenderer
    {
        ...
        public static Color GetColor(VisualizerNode node) => Node.NodeStatus.FAILURE switch
        {
        ...
        private static string GetText(VisualizerNode node) => node.Self.GetType().Name;
